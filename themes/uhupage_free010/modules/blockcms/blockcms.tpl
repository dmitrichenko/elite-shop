...
{if $block == 0}
	...
	<span>{l s='Powered by' mod='uhucms'} <a href="http://www.prestashop.com">PrestaShop</a>&trade; {$ps_version} {l s='Designed by' mod='uhucms'} <a href="http://www.uhupage.com">uhupage</a></span>
